...
# location_sources.py мог безопасно получить текст L7 без циклического импорта.
from location_sources import LOCATION_SOURCE_TEXTS, get_location_source_text
